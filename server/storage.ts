import { users, topics, content, images, questions, matching, videos, matching_attempts, content_ratings, student_streaks, daily_activities, writing_prompts, writing_submissions, assignment, assignment_student_try, student_try, learning_progress, cron_jobs, student_try_content, pending_access_requests, content_views, enhanced_content_ratings, quiz_attempts, student_badges, teaching_sessions, session_participants, session_activities, type User, type InsertUser, type UpsertUser, type Topic, type Content, type Image, type Question, type Matching, type Video, type MatchingAttempt, type InsertMatchingAttempt, type ContentRating, type InsertContentRating, type StudentStreak, type InsertStudentStreak, type DailyActivity, type InsertDailyActivity, type WritingPrompt, type InsertWritingPrompt, type WritingSubmission, type InsertWritingSubmission, type LearningProgress, type InsertLearningProgress, type CronJob, type InsertCronJob, type ContentView, type InsertContentView, type EnhancedContentRating, type InsertEnhancedContentRating, type QuizAttempt, type InsertQuizAttempt, type StudentBadge, type InsertStudentBadge, type TeachingSession, type InsertTeachingSession, type SessionParticipant, type InsertSessionParticipant, type SessionActivity, type InsertSessionActivity } from "@shared/schema";
import { db } from "./db";
