...
export const MarkdownRenderer = ({
  ...
  return (
    <div className={`prose prose-blue dark:prose-invert max-w-none whitespace-pre-wrap font-sans prose-li:-my-1 prose-li:-mb-1 prose-li:-mt-1 prose-li:leading-snug prose-li:pl-0 prose-li:ml-2 prose-li:-py-1 prose-p:my-0 prose-p:mb-0 prose-p:leading-tight prose-ul:my-0 prose-ul:mb-0 prose-ul:pl-2 prose-ul:mt-0 prose-ul:space-y-0 prose-ol:my-0 prose-ol:mb-0 prose-ol:pl-2 prose-ol:mt-0 prose-ol:space-y-0 ${className}`} style={{ lineHeight: '1.2' }}>
